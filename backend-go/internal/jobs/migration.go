...
var batchFourLaneDefinitions = []MigrationLane{
	...
	{ID: "outcomes", Order: 7, PythonModelLane: "io", CeleryQueuePrefix: "io", GoQueue: "outcomes", TaskTypes: []string{
		"market_loop.evaluate_outcomes", "market_loop.refresh_event_market_factors",
	}},
	{ID: "masterdata", Order: 8, PythonModelLane: "io", CeleryQueuePrefix: "io", GoQueue: "masterdata", TaskTypes: []string{
		"market_loop.refresh_crypto_universe", "market_loop.refresh_asset_universe",
		"market_loop.refresh_macro_universe",
	}},
	{ID: "operations", Order: 9, PythonModelLane: "io", CeleryQueuePrefix: "io,evolution", GoQueue: "operations", TaskTypes: []string{
		"market_loop.dispatch_evolve_from_outcomes", "market_loop.monitor_health",
	}},
	{ID: "backfill", Order: 10, PythonModelLane: "io", CeleryQueuePrefix: "io", GoQueue: "backfill", TaskTypes: []string{
		"market_loop.backfill_asset_mappings",
	}},
	{ID: "maintenance", Order: 11, PythonModelLane: "io", CeleryQueuePrefix: "io", GoQueue: "maintenance", TaskTypes: []string{
